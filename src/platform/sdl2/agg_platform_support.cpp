...
namespace agg
{
    ...
    void platform_support::caption(const char* cap)
    {
        ...
        {
            SDL_SetWindowTitle(m_specific->m_window, cap);
    ...
    bool platform_support::init(unsigned width, unsigned height, unsigned flags)
    {
        ...
        unsigned wflags = SDL_WINDOW_SHOWN;
        ...
        m_specific->m_windpw = SDL_CreateWindow(m_caption,
        ...
        m_rbuf_window.attach((unsigned char*)platform_specific->m_surf_window->pixels,
